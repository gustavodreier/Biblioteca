...
if (isset($_POST['enviar'])) {
	...
	echo '<form action="muda_titulo.php" method="post">';
        ...
        echo '<p>Nome:<input name="nome" size="20" maxlenght="100" value="'.$array['nome'].'" type="text"/><br/>';
        echo '<p>Descricao:<input name="desc" size="50" maxlenght="200" value="'.$array['descricao'].'" type="text"/><br/>';
        echo '<center><input name="enviar" type="submit" value="Enviar" class="botao"/></center>';

} else {
?>
	<form action="altera_titulo.php" method="post">
